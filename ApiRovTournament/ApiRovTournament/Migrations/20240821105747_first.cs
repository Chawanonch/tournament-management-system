    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListLevels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListLevels_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListLevels_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListMembers_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListLevels_LevelId",
                table: "ListLevels",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_ListLevels_TournamentId",
                table: "ListLevels",
                column: "TournamentId");

            migrationBuilder.CreateIndex(
                name: "IX_ListMembers_TeamId",
                table: "ListMembers",
                column: "TeamId");
